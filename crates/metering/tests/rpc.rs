...
use base_reth_metering::{MeteringApiImpl, MeteringApiServer, MeterBundleResponse};
...
async fn test_meter_bundle_ignores_bundle_block_number() -> eyre::Result<()> {
    ...
    let response1: base_reth_metering::MeterBundleResponse =
    ...
    let response2: base_reth_metering::MeterBundleResponse =
